...
static struct tbs5520fe_config tbs5520fe_config = {
	.tbs5520fe_address = 0x14,
};
...
static int tbs5520_frontend_attach(struct dvb_usb_adapter *d)
{
	...
	if (tbs5520_properties.adapter->tuner_attach == NULL) {
		d->fe[0] = dvb_attach(tbs5520fe_attach, &tbs5520fe_config,
			&d->dev->i2c_adap);
		if (d->fe[0] != NULL) {
			info("Attached tbs5520FE!\n");
			...
			const struct firmware *frmwr)
{
	...
	const char *filename = "dvb-usb-tbsqbox-id5520.fw";
...
MODULE_AUTHOR("TBS: www.tbsdtv.com");
